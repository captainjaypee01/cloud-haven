...
const Hero = () => {
    return (
        <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/netania-cover.jpg")] bg-no-repeat bg-cover bg-center h-screen'>
            ...
            <h1 className='font-playfair text-gray-900 text-1xl md:text-5xl md:text-[56x] md:leading[56px] font-bold md:font-extrabold max-w-xl mt-2'>Netania De Laiya</h1>
            {/* <h1 className='font-playfair text-gray-900 text-1xl md:text-5xl md:text-[56x] md:leading[56px] font-bold md:font-extrabold max-w-xl mt-2'>Life While Traveling is a Pure Dream.</h1>
