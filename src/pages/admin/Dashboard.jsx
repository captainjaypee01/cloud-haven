            ...
            <div className='flex gap-4 my-8'>
                ...
                <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
                    ...
                    <div className='flex flex-col sm:ml-4 font-medium'>
                        ...
                        <p className="text-neutral-400 text-base">{formatCurrency(dashboardData.totalRevenue)}</p>
                    </div>
                </div>
            </div>
                    ...
                    <tbody className='text-sm'>
                        {dashboardData.bookings.map((item, index) => (
                            <tr key={index}>
                                ...
                                <td className='py-3 px-4 text-gray-700 border-t border-gray-300 text-center'>{formatCurrency(item.totalPrice)}</td>
