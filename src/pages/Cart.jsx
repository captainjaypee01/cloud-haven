                ...
                {items.length === 0 ? (
                    ...
                    <>
                        <div className="space-y-8 mb-8">
                            {items.map(item => {
                                console.log(item.maxGuests, item.adults, item.children)
                                const extraGuests = Math.max((item.adults + item.children) - item.maxGuests, 0);
                        ...
                        <div className="flex gap-3 mt-4 justify-end">
                            <Button variant="destructive" className="cursor-pointer" onClick={clear}>Clear Cart</Button>
                            <Button variant="ghost" className="cursor-pointer" size="lg">Proceed to Checkout</Button>
                        </div>
                    </>
                )}
            </div>
